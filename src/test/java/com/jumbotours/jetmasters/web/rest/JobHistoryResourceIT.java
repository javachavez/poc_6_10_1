package com.jumbotours.jetmasters.web.rest;

import com.jumbotours.jetmasters.JetMastersApp;
import com.jumbotours.jetmasters.domain.JobHistory;
import com.jumbotours.jetmasters.repository.JobHistoryRepository;
import com.jumbotours.jetmasters.repository.search.JobHistorySearchRepository;
import com.jumbotours.jetmasters.service.JobHistoryService;
...
import com.jumbotours.jetmasters.domain.enumeration.Language;
/**
 * Integration tests for the {@link JobHistoryResource} REST controller.
 */
@SpringBootTest(classes = JetMastersApp.class)
...
public class JobHistoryResourceIT {
    ...
    /**
     * This repository is mocked in the com.jumbotours.jetmasters.repository.search test package.
     *
     * @see com.jumbotours.jetmasters.repository.search.JobHistorySearchRepositoryMockConfiguration
     */
    @Autowired
